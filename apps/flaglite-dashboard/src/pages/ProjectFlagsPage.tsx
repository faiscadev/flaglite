...
import { Plus, RefreshCw, Trash2, Flag as FlagIcon } from 'lucide-react';
    ...
    <Layout>
      ...
      <div className="mb-6">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            <h1 className="text-2xl font-bold text-zinc-900">Flags</h1>
            <p className="text-zinc-500 mt-1">
              Manage feature flags for {currentProject.name}
            </p>
          </div>
      ...
      {isLoading ? (
        ...
        <div className="bg-white rounded-xl border border-zinc-200 p-12 text-center">
          <FlagIcon className="w-12 h-12 text-zinc-400 mx-auto mb-4" />
          <p className="text-zinc-500 mb-4">No feature flags yet</p>
          <Button onClick={() => setIsCreateModalOpen(true)}>
            <Plus className="w-4 h-4 mr-2" />
                ...
                <tr key={flag.key} className="hover:bg-zinc-50">
                  <td className="px-6 py-4">
                    <Link
                      ...
                      className="block"
                    >
                      <div className="text-sm font-medium text-zinc-900 hover:text-green-600">
                        {flag.name}
                      </div>
                      {flag.description && (
                  ...
                  <td className="px-6 py-4">
                    <code className="px-2 py-1 text-xs bg-zinc-100 rounded font-mono">
                      {flag.key}
                    </code>
                  </td>
                  <td className="px-6 py-4">
